...
function gerarRecibo() {
    ...
    if (validaCpfCnpj(cpfCnpj))  {
        ...
        document.getElementById("paragrafoValor").innerHTML = (valorSalario.toString() == '1' ? (valorSalario.toString().extenso() + " real").toUpperCase() : (valorSalario.toString().extenso() + " reais").toUpperCase());
        ...
        document.getElementById("assinatura").innerHTML = empregado;


        if (duasVias.checked == true) {
            document.getElementById("reciboSalario2").style.display = "block";
            document.getElementById("valorSalario2").innerHTML = "R$: " + valorSalario + "#";
            document.getElementById("paragrafoNome2").innerHTML = "Eu, " + empregado;
            document.getElementById("paragrafoTitulo2").innerHTML = "Declaro para todos os efeitos, ter recebido a título de " + aTituloDe + " a importância de:";
            document.getElementById("paragrafoValor2").innerHTML = (valorSalario.toString() == '1' ? (valorSalario.toString().extenso() + " real").toUpperCase() : (valorSalario.toString().extenso() + " reais").toUpperCase());
            document.getElementById("paragrafoTexto2").innerHTML = "e em concordância com o disposto no Art. 462, da CLT, tenho plena consciência de que o respectivo "
            + "valor será descontado, pelo empregador: " + empregador + ", CNPJ: " + cpfCnpj + ", do pagamento da minha remuneração mensal relativa à folha do mês de "
            + remuneracaoMes + " e incidindo na base de cálculo de encargos sociais e fiscais para todos os efeitos legais.";
            if (chavePix != null && chavePix != undefined && chavePix != "") {
            ...
            document.getElementById("assinatura2").innerHTML = empregado;
